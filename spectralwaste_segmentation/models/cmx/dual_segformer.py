...
class RGBXTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, extra_in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        self.extra_patch_embed1 = OverlapPatchEmbed(img_size=img_size, patch_size=7, stride=4, in_chans=extra_in_chans,
                                              embed_dim=embed_dims[0])
...
class mit_b0(RGBXTransformer):
    def __init__(self, fuse_cfg=None, **kwargs):
        super(mit_b0, self).__init__(
            extra_in_chans=kwargs['extra_in_chans'],
